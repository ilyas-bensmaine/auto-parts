          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                @can('user-create')
                  <a class="btn btn-success float-sm-right" href="{{ route('admin.pieces.create', ['language'=> app()->getlocale()]) }}"> {{__('Create New Category')}}</a>
                @endcan
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $piece->refa}}</td>
                      <td>
                        {{$piece->categories()->count()}}
                      </td>
                      <td>
                        {{$marque->modeles()->count()}}
                      </td>
                       <td>
