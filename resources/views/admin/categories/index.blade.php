                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="btn btn-success float-sm-right"
                                href="{{ route('admin.categories.create', ['language'=> app()->getlocale()]) }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{-- <a class="btn btn-default btn-sm"
                                                onclick="handleDetail({{$user}}, {{ $user->getRoleNames()}})">{{__('Detail')}}</a>
                                            @can('user-edit')
                                            <a class="btn btn-primary btn-sm"
                                                href="{{ route('admin.users.edit', ['language'=> app()->getlocale(), 'user'=>$user->id]) }}">{{__('Editer')}}</a>
                                            @endcan
                                            @can('user-delete')
                                            ...
                                            <a class="btn btn-danger btn-sm"
                                                onclick="handleDelete( {{app()->getlocale()}} ,{{$user->id}})">{{__('Supprimer')}}</a>
                                            @endif
                                            @endcan --}}
                                        </td>
                                    </tr>
